     ...
     )
{
    ...
    // Print message for ending the simulation
    if (isBeforeEndTime == false)
    {
     ...
     )
{
    ...
    // Decide how currentTime will be modified annd what event to schdule
     ...
     )
{
    ...
    int currTimeOccur = currEvent.getTimeOccurs();
    
    // Sign for ending the simulation
    if ( currTimeOccur >= timeToStopSim)
    {
    ...
    {
        // The if..else.. statement here is not simplifided by private
        // functions, since different queues are modified inside
        ...
        if (northQueue.getNumElems() > 0)
        {
            for (int i = 0; i < numNorthYello; i++)
            {
                ...
                if (randAdvanceYellow <= percentCarsAdvanceOnYellow)
                {
                    ...
                    {
                        cout <<
                        "  No north-bound cars waiting to advance on yellow"
                        << endl;
                    }
                }
                else //if (randAdvanceYellow > percentCarsAdvanceOnYellow)
                {
                    cout <<
        ...
        if (eastQueue.getNumElems() > 0)
        {
            for (int i = 0; i < numEastYello; i++)
            {
                ...
                if (randAdvanceYellow <= percentCarsAdvanceOnYellow)
                {
                    ...
                    {
                        cout <<
                        "  No east-bound cars waiting to advance on yellow"
                        << endl;
                    }
                }
                else
